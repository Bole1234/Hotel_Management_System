                                ...
                                if($feachData->num_rows()>0){
                                    ...
                                    foreach ($feachData->result() as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $row->addressLine1 ." ".$row->addressLine2." ".$row->city?></td>
                                            <td><a href="#" class="offset-2 item-delete" data-toggle="tooltip" title="Remove" data="<?php echo $row->orderID ?>">
