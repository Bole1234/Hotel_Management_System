  ...
  <ul class="navbar-nav ml-auto">
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="margin-top:7px">
        <a class="dropdown-item" href="<?php echo base_url('Home/user_account');?>"><i class="fas fa-user"></i>  My profile</a>
         <a class="dropdown-item" href="<?php echo base_url('Home/password_change');?>"><i class="fas fa-key"></i>  Password Change</a>
        
      <div class="dropdown-divider "></div>
      <a class="dropdown-item w3-light-gray" href="<?php echo base_url('Login/logout');?>"><i class="fas fa-power-off"></i> &nbsp; Logout</a>
      </div>
    </li>
  </ul>
